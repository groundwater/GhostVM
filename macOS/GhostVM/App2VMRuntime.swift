...
final class App2VMSessionRegistry {
    ...
    private static func promptMigration(bundleURL: URL, store: App2VMStore, vmID: App2VM.ID, recovery: Bool) {
        DispatchQueue.main.async {
            ...
            let icon = NSImageView(frame: NSRect(x: 20, y: 90, width: 48, height: 48))
            ...
            titleLabel.frame = NSRect(x: 78, y: 118, width: 320, height: 20)
            ...
            infoLabel.frame = NSRect(x: 78, y: 40, width: 320, height: 76)
        ...
        DispatchQueue.global(qos: .userInitiated).async {
            do {
                ...
                DispatchQueue.main.async {
                    ...
                    cancelButton.target = progressWindow
