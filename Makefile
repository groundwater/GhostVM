...
APP2_SOURCES := SwiftUIDemoApp.swift App2Models.swift App2VMRuntime.swift App2VMDisplayHost.swift App2IPSW.swift FinderAdapter.swift SavePanelAdapter.swift App2AppDelegate.swift AppIconAdapter.swift
